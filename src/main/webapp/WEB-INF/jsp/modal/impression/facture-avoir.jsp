...
<div id="impression-facture-avoir" class="facture-A5 container d-flex justify-content-center index-none">
    ...
    <div class="invoice">
      ...
      <div class="invoice-header-none">
        <div class="row">
          ...
          <div class="col-6 d-flex justify-content-center">
            <address class="m-t-5 m-b-5">
              <strong class="text-inverse">Avoir du Facture n° : <span class="label-numero-facture">-</span></strong><br>
