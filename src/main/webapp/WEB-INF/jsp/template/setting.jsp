...
<div class="end-bar">
  <div class="rightbar-title">
    <a class="end-bar-toggle float-end">
  ...
  <div class="rightbar-content h-100" data-simplebar="">
    ...
    <div class="p-3">
      ...
      <div class="form-check form-switch mb-1">
        ...
        <label class="form-check-label" for="boxed-check">En box</label>
      </div>


      <!-- Left Sidebar-->
      <h5 class="mt-4">Bar latéral gauche</h5>
      <hr class="mt-1">
      <div class="form-check form-switch mb-1">
        <input class="form-check-input" type="checkbox" name="theme" value="default" id="default-check">
        <label class="form-check-label" for="default-check">Par défaut</label>
      </div>
      ...
      <div class="form-check form-switch mb-1">
        ...
        <label class="form-check-label" for="fixed-check">Fixe</label>
      </div>

      <div class="form-check form-switch mb-1">
        <input class="form-check-input" type="checkbox" name="compact" value="condensed" id="condensed-check">
        <label class="form-check-label" for="condensed-check">Condenser</label>
      </div>

      <div class="form-check form-switch mb-1">
        <input class="form-check-input" type="checkbox" name="compact" value="scrollable" id="scrollable-check">
        <label class="form-check-label" for="scrollable-check">En défilement</label>
      </div>

      <div class="d-grid mt-4">
        <button class="btn btn-primary" id="resetBtn">Restaurer par défaut</button>
      </div>
    </div> <!-- end padding-->
...
<%--<script src=â€https://cdnjs.cloudflare.com/ajax/libs/jquery.inputmask/3.3.4/jquery.inputmask.bundle.min.jsâ€></script>--%>
