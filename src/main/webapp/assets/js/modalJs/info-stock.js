$(function() {
    ...
    $(namespace + '.btn-update-stock').on('click',function(){
        ...
        let url = "http://80.241.220.194:8080/admin-0.0.1-SNAPSHOT/api/v1/articles/"+$articleId+"/"+$filialeId;
    ...
    $("#btn-enregistrer-inventaire-stock").click(()=>{
       ...
       let url = "http://80.241.220.194:8080/admin-0.0.1-SNAPSHOT/api/v1/info";
    ...
    $(".btn-enregistrer-qtt-alert").click(()=>{
        ...
        let url = "http://80.241.220.194:8080/admin-0.0.1-SNAPSHOT/api/v1/inventories-alert/"+$filialeId+"/"+$articleId+"/"+qtt_alert;
