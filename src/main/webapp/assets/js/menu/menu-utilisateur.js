$(function () {
    $fonctionUrl = _url + "api/v1/fonctions";
    $userUrl = _url + "api/v1/users";
    $NEW_USER = true;
    ...
    */
    ...
    const init_form = ($userId)=>{
        let url = _url + "api/v1/users/"+$userId;
    ...
    $(document).on("click",namespace+"#search-btn",()=>{
        ...
        if (text!==""){
            let url = _url + "api/v1/users/name/"+filiale_id+"/"+text;
            execute_ajax_request("get",url,null,(data)=> {
    ...
    $(document).on("click",namespace+"#refresh-btn",()=>{
        let url = _url + "api/v1/subsidiaries/"+filiale_id+"/users";
        execute_ajax_request("get",url,null,(data)=> {
            clear_table(namespace+"#table-liste-utilisateur");
            append_user_item(data)
        });
