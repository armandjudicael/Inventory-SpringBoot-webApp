$(function(){
    ...
    let url = "http://80.241.220.194:8080/admin-0.0.1-SNAPSHOT/api/v1/magasins/";
    ...
    $(document).on('change',namespace+"#magasin-select-operation",function(){
        ...
        if (magasinId === "toutes")  ressource_url = "http://80.241.220.194:8080/admin-0.0.1-SNAPSHOT/api/v1/subsidiaries/"+subsisdiary_id+"/activities";
    ...
    $(namespace +"#search-button").click(()=>{
            ...
            if (beginDate!==undefined && beginDate!==null
                ...
                && beginDate!=="" && endDate!==""){
                let url = "http://80.241.220.194:8080/admin-0.0.1-SNAPSHOT/api/v1/subsidiaries/"+filiale_id+"/activities/date/"+beginDate+"/"+endDate;
