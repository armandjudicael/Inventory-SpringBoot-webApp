$(function(){
    ...
    $(document).on('change',namespace+"#magasin-select-operation",function(){
        ...
        if (magasinId === "toutes")  ressource_url = _url + "api/v1/subsidiaries/"+subsisdiary_id+"/activities";
    ...
    $(namespace +"#search-button").click(()=>{
            ...
            if (beginDate!==undefined && beginDate!==null
                ...
                && beginDate!=="" && endDate!==""){
                let url = _url + "api/v1/subsidiaries/"+filiale_id+"/activities/date/"+beginDate+"/"+endDate;
