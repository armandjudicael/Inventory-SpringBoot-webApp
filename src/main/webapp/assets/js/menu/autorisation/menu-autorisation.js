$(function() {
    ...
    $(document).on("click",namespace+".edit-autorisation",function (){
       ...
       let text = $(this).text();
       let url = "http://80.241.220.194:8080/api/v1/fonctionnalities/autorization/"+feature_id+"/"+$fonction_id+"/"+(text==="Desactiver" ? 0 : 1);
  ...
  const MENU_TAB = ["dashboard",
    ...
    $(document).on("click",namespace+"#save-welcome-page-btn",function (){
        ...
        if ($fonction_id!==0){
            let url = "http://80.241.220.194:8080/api/v1/fonctions/"+$fonction_id+"/welcome-page/"+value;
