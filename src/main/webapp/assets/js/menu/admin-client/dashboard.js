$(function () {
    ...
    function persist_filiale(){
        ...
        let url = "http://80.241.220.194:8080/admin-0.0.1-SNAPSHOT/api/v1/subsidiaries";
    ...
    function persist_Default_user(){
        ...
        let url = "http://80.241.220.194:8080/admin-0.0.1-SNAPSHOT/api/v1/users";
    ...
    function persist_Fonction(filiale) {
        ...
        let url = "http://80.241.220.194:8080/admin-0.0.1-SNAPSHOT/api/v1/fonctions";
