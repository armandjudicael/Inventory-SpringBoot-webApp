$(function () {
    ...
    const PRICES_RESOURCES = "http://80.241.220.194:8080/api/v1/prices";
    const $table_prix = $(namespace+"#table-prix tbody");
    /*
    EVENT MANAGER
     */
    const SUBSDIARIES_URL = "http://80.241.220.194:8080/api/v1/subsidiaries";
   ...
   //     affecter à mis a jour prix
    ...
    $(document).on("click",namespace+"#refresh-btn",()=>{
        ...
        let url = "http://80.241.220.194:8080/api/v1/subsidiaries/"+filialeId+"/prices";
    ...
    $(document).on("keyup",namespace+"#prices-search",()=>{
        ...
        if ( text!==undefined &&  text!==""){
            let url = "http://80.241.220.194:8080/api/v1/subsidiaries/"+filialeId+"/prices/"+text;
            execute_ajax_request("get",url,null,(data)=> append_price_item(data));
